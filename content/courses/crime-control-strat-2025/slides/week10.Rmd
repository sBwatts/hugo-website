...
Given that the cost of this program is steep, it can be hard to get a city council on board to spend millions of dollars on a program that has little empirical support
