...
- prior to more formalized policing in the United states there were two forms of policing: watchmen and slave patrols, in some cases there were constables overseeing much of what the watchmen were doing

- the first "modern" police department in the US was in 1838 Boston, by the 1880s all major US cities had a local police force

- the development of policing in the US closely resembled England with the exception of 1) decentralization, 2) firearms, and 3) slave patrols

- the early days of policing was highly political -- so political that if you did not align politically with the ward politician you may lose your job
...
???
- reform era was about professionalization, making policing a respectable profession that included crime fighting

- More para-militaristic style with hierarchical command chain

- Technological advancements changed the methods of policing during this era
---
# Community Problem-Solving Era
...
???
- community oriented policing was introduced against the backdrop of the civil rights movement, Vietnam protests, and the kerner commission report which focused focused on the racial divide in america and the root causes of crime and disorder

- gave officers and sergeants more discretion to help communities the way they saw fit based on community customs/norms

- reinserted foot patrol and placed an emphasis on community feedback
...
???
- another experiment in Newark focused on specifically foot patrol

- foot patrol appears to have an effect on perceptions of crime but not crime
...
meme <- meme_get("ExpandingBrain") %>% 
  meme_text_brain("Police do not reduce crime", 
