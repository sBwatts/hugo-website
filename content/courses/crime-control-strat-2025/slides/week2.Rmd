...
**Description:** To reduce gun violence, gun buyback programs offer cash in return for guns to, hopefully, reduce gun violence. These programs are often implemented locally.

**Evidence:** The evidence on this intervention is limited and mixed at best. There are no rigorous evaluations of gun buyback programs. Moreover, it is frequently the case that few guns are turned in, making it unlikely to meaningfully impact gun violence rates. 
]
...
```
.center[[Generated with `memer` in R](https://github.com/sctyner/memer)]
